   ...
   <>
      ...
      <form action="">
          <div className='mt-5 container mx-auto flex items-center justify-between'>
               ...
               <div>
                   <input type="text" name="title" value={post.title} id="" placeholder='Title' onChange={(e) => handleChange(e)} className='w-[84vw] border-2 border-gray-200 outline-none py-[1px] px-3 text-xl rounded-md' />
               </div>
               <div>
                 <button type='button' onClick={() => updateBlogPost()} className='bg-orange-500 text-lg text-white hover:bg-orange-600 font-bold rounded-md py-1 px-5'>Update</button>
               </div>
          </div>
          <div className='container mx-auto mt-5'>
              <textarea name="description" value={post.description} id="" placeholder='Tell your story...' onChange={(e) => handleChange(e)} className='outline-none border-2 border-gray-200 w-[96.7vw] h-[23vh] rounded-md py-[2px] px-3 text-xl'></textarea>
          </div>
      </form>
   </>
  )
